...
C_DEPS += \
./APP/lib/lvgl/src/widgets/button/lv_button.d 
...
APP/lib/lvgl/src/widgets/button/%.o APP/lib/lvgl/src/widgets/button/%.su APP/lib/lvgl/src/widgets/button/%.cyclo: ../APP/lib/lvgl/src/widgets/button/%.c APP/lib/lvgl/src/widgets/button/subdir.mk
...
clean: clean-APP-2f-lib-2f-lvgl-2f-src-2f-widgets-2f-button

clean-APP-2f-lib-2f-lvgl-2f-src-2f-widgets-2f-button:
	-$(RM) ./APP/lib/lvgl/src/widgets/button/lv_button.cyclo ./APP/lib/lvgl/src/widgets/button/lv_button.d ./APP/lib/lvgl/src/widgets/button/lv_button.o ./APP/lib/lvgl/src/widgets/button/lv_button.su

.PHONY: clean-APP-2f-lib-2f-lvgl-2f-src-2f-widgets-2f-button
